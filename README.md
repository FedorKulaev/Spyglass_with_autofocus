# Краткое описание
Устройство представляет собой довольно громоздкую подзорную трубу, которая обладает возможностью фокусироваться на объекты, находящиеся в диапазоне 3-10000 метров.
